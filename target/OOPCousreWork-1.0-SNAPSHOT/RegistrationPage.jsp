...
<form name="ac" action="registration" method="post">
    <p>
        ...
        <input name="username" type="text" size="30" placeholder="Уведить логин">
    </p>
    ...
    <p>
        ...
        <input name="userPassword" type="password" size="30" placeholder="Уведить пароль">
    </p>
    <c:choose>
    ...
    <p>
        ...
        <input name="userPasswordSubmit" type="password" size="30" placeholder="Уведить пароль">
    </p>
    <c:choose>
    ...
    <p>
        ...
        <input name="userEmail" type="email" size="30" placeholder="Уведить адрес електронной пошти">
    </p>
    <c:choose>
